  ...
  return (
    <div className="min-h-screen bg-[#020713] text-white">
      ...
      <div className="relative mx-auto max-w-[1450px] px-4 pb-8 pt-3 lg:px-6">
        <header className="rounded-2xl border border-[#1f3158]/85 bg-[#050f25]/85 px-4 py-3 backdrop-blur-2xl lg:px-5">
          <div className="flex items-center justify-between gap-6">
            <div className="flex min-w-0 items-center gap-2.5">
              <img src={platformLogo} alt="CinemaLab logo" className="h-6 w-6 rounded object-cover" />
              <p className="text-[13px] font-semibold leading-none tracking-wide text-[#f0f4ff]">CinemaLab</p>
              <p className="text-[10px] text-[#8898bf]">Билетная платформа</p>
            </div>
            <nav className="flex items-center gap-5 text-[10px] text-[#b7c4e8] lg:text-[11px]">
              {navItems.map((item) => (
        ...
        <section className="mt-3 grid gap-3 lg:grid-cols-[1.06fr_1.34fr]">
          <div className="relative overflow-hidden rounded-[22px] border border-[#2f4172]/90 bg-[linear-gradient(162deg,rgba(8,21,50,0.95)_0%,rgba(4,12,34,0.98)_66%)] p-6 shadow-[0_42px_100px_rgba(6,16,42,0.62)] lg:p-7">
            ...
            <span className="inline-flex rounded-lg border border-[#4e5f8f] bg-[#132345]/88 px-3 py-1 text-[10px] font-medium tracking-wide text-[#b7c3e9] shadow-[inset_0_1px_0_rgba(186,205,255,0.22)]">Билетная платформа</span>
            <h1 className="mt-4 text-[52px] font-semibold leading-[0.94] tracking-tight lg:text-[62px]">
              Единая платформа
              <br />
              управления
              <br />
            ...
            <p className="mt-5 max-w-[560px] text-[11px] leading-[1.55] text-[#c0cdea] lg:text-[12px]">
            ...
            <div className="mt-5 grid grid-cols-3 gap-2.5">
              {["Единый реестр мероприятий", "Единый реестр билетов", "Отчётность и контроль"].map((item) => (
                <div key={item} className="rounded-xl border border-[#354b79]/90 bg-[linear-gradient(180deg,rgba(15,33,67,0.86),rgba(8,20,46,0.96))] px-2.5 py-2.5 shadow-[inset_0_1px_0_rgba(177,200,255,0.18),0_8px_18px_rgba(6,14,34,0.45)]">
          ...
          <div className="relative overflow-hidden rounded-[22px] border border-[#324b8f]/90 bg-[linear-gradient(155deg,rgba(7,19,45,0.98),rgba(5,14,34,0.99))] p-4 shadow-[0_0_120px_rgba(97,98,255,0.26)] lg:p-5">
            ...
            <div className="relative flex items-start justify-between gap-3">
              ...
              <button className="rounded-md border border-[#7f6eff]/40 bg-gradient-to-r from-[#6543ff] to-[#b257ff] px-2.5 py-1 text-[9px] font-medium shadow-[0_8px_20px_rgba(132,94,255,0.4)]">
            ...
            <div className="relative mt-3 space-y-2.5">
              {previewRows.map((r) => (
                <div key={r.title} className="rounded-xl border border-[#2e4573] bg-[linear-gradient(165deg,rgba(10,28,56,0.94),rgba(6,18,39,0.98))] p-2.5 shadow-[inset_0_1px_0_rgba(171,195,248,0.16),0_14px_28px_rgba(6,14,35,0.48)]">
                  <div className="grid items-center gap-2.5 md:grid-cols-[auto_1.7fr_auto_1fr]">
                    <div className="h-10 w-16 overflow-hidden rounded-md border border-[#40619d] bg-gradient-to-br from-[#962fff] via-[#335dff] to-[#23b1d7] shadow-[0_8px_18px_rgba(69,109,255,0.35)]" />
        ...
        <section className="mt-3 grid gap-3 lg:grid-cols-[1.24fr_1fr]">
          <div className="rounded-[20px] border border-[#203259]/90 bg-[linear-gradient(175deg,rgba(5,14,34,0.98),rgba(4,13,33,0.86))] p-4 lg:p-5">
            ...
            <div className="mt-3 grid grid-cols-1 gap-2 lg:grid-cols-4">
              {quickAccessCards.map((card) => (
                <Link
                  key={card.title}
                  to={card.route}
                  className={`group rounded-xl border border-[#2c426a] bg-gradient-to-b ${card.glow} p-3.5 shadow-[inset_0_1px_0_rgba(178,199,250,0.14),0_12px_24px_rgba(6,15,36,0.33)] transition duration-300 hover:-translate-y-0.5 hover:border-[#5a79bb]/90`}
                >
          ...
          <div className="rounded-[20px] border border-[#203259]/90 bg-[linear-gradient(175deg,rgba(5,14,34,0.98),rgba(4,13,33,0.86))] p-4 lg:p-5">
            ...
            <div className="mt-3 grid gap-2 lg:grid-cols-3">
              <button onClick={runReset} className="rounded-xl border border-[#31496f] bg-gradient-to-b from-[#311450]/28 to-[#08142e] p-3.5 text-left shadow-[inset_0_1px_0_rgba(190,149,255,0.18),0_8px_18px_rgba(6,15,36,0.28)] transition hover:border-[#6b5bbc]/70">
              ...
              <button onClick={runGenerate} className="rounded-xl border border-[#31496f] bg-gradient-to-b from-[#0f345f]/34 to-[#08142e] p-3.5 text-left shadow-[inset_0_1px_0_rgba(145,208,255,0.2),0_8px_18px_rgba(6,15,36,0.28)] transition hover:border-[#5788c0]/70">
              ...
              <button onClick={runScenario} className="rounded-xl border border-[#31496f] bg-gradient-to-b from-[#134b44]/26 to-[#08142e] p-3.5 text-left shadow-[inset_0_1px_0_rgba(143,233,203,0.18),0_8px_18px_rgba(6,15,36,0.28)] transition hover:border-[#59ac91]/70">
