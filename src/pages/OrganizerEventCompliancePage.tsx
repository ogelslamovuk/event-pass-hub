      ...
      <div className="mx-auto max-w-5xl rounded-2xl border p-6 space-y-6" style={{ borderColor: "rgba(255,255,255,0.10)", background: "#111A24" }}>
        ...
        <section className="space-y-3">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <div className="flex items-center gap-2">
              <input className="h-10 rounded px-3 bg-[#0F1620] border flex-1" placeholder="Наименование" value={form.title} onChange={(e) => setForm((p) => ({ ...p, title: e.target.value }))} />
              <FieldHelp text="Официальное название мероприятия для рассмотрения." />
            </div>
            <div className="flex items-center gap-2">
              <input className="h-10 rounded px-3 bg-[#0F1620] border flex-1" placeholder="Тип мероприятия" value={form.eventType} onChange={(e) => setForm((p) => ({ ...p, eventType: e.target.value }))} />
              <FieldHelp text="Формат события: концерт, спектакль, фестиваль и другие варианты." />
            </div>
            ...
            <div className="flex items-center gap-2">
              <input className="h-10 rounded px-3 bg-[#0F1620] border flex-1" placeholder="Место проведения" value={form.venueName} onChange={(e) => setForm((p) => ({ ...p, venueName: e.target.value }))} />
              <FieldHelp text="Название площадки в рамках текущего кейса." />
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <FieldHelp text="Фактический адрес проведения мероприятия." />
          </div>
        ...
        <div className="flex gap-3">
          <div className="flex items-center gap-2">
            ...
            <FieldHelp text="Сохраняет форму без отправки в регуляторный контур." />
          </div>
          <div className="flex items-center gap-2">
            ...
            <FieldHelp text="Отправляет заявку на рассмотрение с текущими артефактами." />
          </div>
        </div>
